...
namespace PanGuLuceneDemo
{
    class Program
    {
        ...
        static void ArticleTest()
        {
            ...
            ArticleIndexHelper.CreateIndex(article5);
            Console.WriteLine("创建文章5索引");
            ...
            while (q.ToLower() != "exit")
            {
                ...
                if (q.ToLower() == "delete")
                {
                    Console.WriteLine("删除了Id为8949393的文章");
                    ArticleIndexHelper.DeleteIndex(new Article() { Id = 8949393 });
                }
                if (q.ToLower() == "update")
                {
                    Console.WriteLine("更新文章Id为8949393的内容");
                    ArticleIndexHelper.UpdateIndex(article4);
                }
        ...
        static void ProductIndexTest()
        {
            ...
            ProductIndexHelper.CreateIndex(product1);
            Console.WriteLine("创建商品1索引...");
            ProductIndexHelper.CreateIndex(product2);
            Console.WriteLine("创建商品2索引...");
            ProductIndexHelper.CreateIndex(product3);
            Console.WriteLine("创建商品3索引...");
            ProductIndexHelper.CreateIndex(product4);
            Console.WriteLine("创建商品4索引...");
